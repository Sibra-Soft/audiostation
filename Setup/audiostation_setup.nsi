...
Name "${PRODUCT_NAME}"
OutFile "Audiostation_windows_setup.exe"
...
Section "!Audiostation" SEC_main
  ...
  File ".\packages\AdioLibrary.1.0.3\tools\AdioLibrary.ocx"
  File ".\deps\bass.dll"
...
Section "VirtualMIDISynth" SEC05
  SetOutPath "$INSTDIR"
  SetOverwrite on
  File ".\publish\VirtualMIDISynth-21370.exe"
SectionEnd
...
Section -Post
  ...
  Exec "$INSTDIR\VirtualMIDISynth-21370.exe"
SectionEnd
