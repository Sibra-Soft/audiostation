Attribute VB_Name = "modBassWasApi"
...
Global Const BASS_ERROR_WASAPI_CATEGORY = 5002 ' can't set category
Global Const BASS_ERROR_WASAPI_DENIED = 5003 ' access denied
...
Global Const BASS_WASAPI_ASYNC = &H100

Global Const BASS_WASAPI_CATEGORY_MASK = &HF000
Global Const BASS_WASAPI_CATEGORY_OTHER = &H0
Global Const BASS_WASAPI_CATEGORY_FOREGROUNDONLYMEDIA = &H1000
Global Const BASS_WASAPI_CATEGORY_BACKGROUNDCAPABLEMEDIA = &H2000
Global Const BASS_WASAPI_CATEGORY_COMMUNICATIONS = &H3000
Global Const BASS_WASAPI_CATEGORY_ALERTS = &H4000
Global Const BASS_WASAPI_CATEGORY_SOUNDEFFECTS = &H5000
Global Const BASS_WASAPI_CATEGORY_GAMEEFFECTS = &H6000
Global Const BASS_WASAPI_CATEGORY_GAMEMEDIA = &H7000
Global Const BASS_WASAPI_CATEGORY_GAMECHAT = &H8000
Global Const BASS_WASAPI_CATEGORY_SPEECH = &H9000
Global Const BASS_WASAPI_CATEGORY_MOVIE = &HA000
Global Const BASS_WASAPI_CATEGORY_MEDIA = &HB000
...
' Special WASAPIPROCs
Global Const WASAPIPROC_PUSH = 0  ' push output
Global Const WASAPIPROC_BASS = -1 ' BASS channel
